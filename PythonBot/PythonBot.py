...
async def on_ready():
    ...
    await bot.change_presence(game=discord.Game(name='being mentally challenged'), status=discord.Status.do_not_disturb)
...
bot.run('MjgxNTY1Nzg4ODg3MDU2Mzk0.DV0hfA.Xq5NjD-2C7lKdkUMfkqHXl2C34s')
